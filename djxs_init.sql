...
CREATE TABLE IF NOT EXISTS `djxs_flash_sale_item` (
  ...
  `goods_id` bigint unsigned NOT NULL COMMENT '商品ID（短剧ID/小说ID）',
  `title_snapshot` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品标题快照',
  `cover_snapshot` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品封面快照',
...
CREATE TABLE IF NOT EXISTS `djxs_flash_sale_order` (
  ...
  `activity_id` bigint unsigned NOT NULL COMMENT '活动ID',
  `item_id` bigint unsigned NOT NULL COMMENT '活动商品ID',
  `user_id` int NOT NULL COMMENT '用户ID',
  `request_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '幂等请求ID',
  `buy_count` int NOT NULL DEFAULT 1 COMMENT '购买数量',
  `seckill_price` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '成交秒杀单价',
...
CREATE TABLE IF NOT EXISTS `djxs_flash_sale_risk_blacklist` (
  ...
  `target_value` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '命中对象值（用户ID/IP/设备ID）',
  ...
  `created_by` int NOT NULL DEFAULT 0 COMMENT '创建人管理员ID',
  `updated_by` int NOT NULL DEFAULT 0 COMMENT '更新人管理员ID',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='秒杀风控黑名单表';

CREATE TABLE IF NOT EXISTS `djxs_flash_sale_risk_log` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `scene` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'create_order' COMMENT '风控场景',
  `reason` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '命中原因编码',
  `user_id` int NOT NULL DEFAULT 0 COMMENT '用户ID',
  `activity_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT '活动ID',
  `item_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT '活动商品ID',
  `client_ip` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '客户端IP',
  `device_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '设备ID',
  `extra_json` text COLLATE utf8mb4_unicode_ci COMMENT '扩展上下文JSON',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='秒杀风控命中日志表';
...
INSERT INTO `djxs_admin_role` (`id`, `code`, `name`, `status`, `create_time`) VALUES (1,'super_admin','超级管理员',1,'2026-04-18 12:17:47');
